...
std::ostream &Control_input_Pin_in_control::to_stream(
    std::ostream &os, CompoMe::Serialization_context_export &p_ctx) const {
  os << "{";
  os << "type:"
     << "Embded::IO::esp32::Control_input_Pin_in_control";
...
std::istream &Control_input_Pin_in_control::from_stream(
  ...
  do {
    ...
    case str2int("type"): {
      ...
      if (t.first != "Embded::IO::esp32::Control_input_Pin_in_control") {
        throw "Wrong Type: ";
      }
      break;
    }
    ...
    default:
      std::cerr << "wrong attribute: \"" << args
                << "\" not in provide Control_input_Pin_in_control";
