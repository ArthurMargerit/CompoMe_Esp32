...
#include "Components/Embded/IO/esp32/Pin_in_Pin_in_control.hpp"
...
class Pin_in : public CompoMe::Component {
...
public:
  ...
  Pin_in_Pin_in_control &get_control();
...
std::ostream &operator<<(std::ostream &os, const Pin_in &c);
std::istream &operator>>(std::istream &is, Pin_in &c);
