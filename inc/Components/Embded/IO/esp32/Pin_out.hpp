...
#include "Components/Embded/IO/esp32/Pin_out_Pin_out_control.hpp"
...
class Pin_out : public CompoMe::Component {
...
public:
  ...
  Pin_out_Pin_out_control &get_control();
...
public:
  ...
  // INTERFACE ////////////////////////////////////////////////////////////////
  // PROVIDE
  Pin_out_Pin_out_control control;
...
std::ostream &operator<<(std::ostream &os, const Pin_out &c);
std::istream &operator>>(std::istream &is, Pin_out &c);
